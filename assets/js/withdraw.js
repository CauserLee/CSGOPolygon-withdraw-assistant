let next             = new Map();
const target         = document.querySelector("#left .reals");
const targetRight    = document.querySelector("#right .reals");
...
let observerRight    = new MutationObserver(function () {
    $(document).off("click", ".slot-right-ext");
    $(document).on("click", ".slot-right-ext", function () {
        $(this).parent().remove();
        $(".placeholder-right-ext[data-pos='" + $(this).data("pos") + "']").append($(this).clone());
        addPadding("#right", 4);
    });
});
let observerRightExt = new MutationObserver(function () {
    addListener();
});
...
$(document).ready(function () {
    ...
    const targetRightExt = document.querySelector("#right-ext");
...
function addListener() {
    $(document).off("click", "#right-ext .slot:not(.reject)");
